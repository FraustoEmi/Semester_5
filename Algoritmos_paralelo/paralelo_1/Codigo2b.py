...
def multiplicacion_matrices_secuencial(A, B):
    ...
    if A.shape[1] != B.shape[0]:
        raise ValueError("Las dimensiones de las matrices no son compatibles para multiplicación")
...
def prueba_secuencial():
    ...
    tamaño = 200  # Reducido para pruebas más rápidas
...
def comparar_rendimiento():
    ...
    for tamaño in tamanos:
        ...
        # Threading (4 hilos)
        inicio = time.time()
        C_thr = multiplicacion_matrices_threading(A, B, 2)
